...
namespace RestWithASPNET10Erudio.Controllers.V1
{
    ...
    public class PersonController : ControllerBase
    {
        ...
        [HttpGet]
        [ProducesResponseType(200, Type = typeof(List<PersonsDTO>))]
        ...
        [HttpGet("{id}")]
        [ProducesResponseType(200, Type = typeof(PersonsDTO))]
        [ProducesResponseType(400)]
        [ProducesResponseType(401)]
        ...
        [ProducesResponseType(400)]
        [ProducesResponseType(401)]
        public IActionResult Put([FromBody] PersonsDTO person)
        {
        ...
        [HttpDelete("{id}")]
        [ProducesResponseType(204, Type = typeof(PersonsDTO))]
        [ProducesResponseType(400)]
        [ProducesResponseType(401)]
